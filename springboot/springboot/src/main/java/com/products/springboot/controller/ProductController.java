...
import com.products.springboot.service.ProductPriceService;
...
public class ProductController {
	...
	private ProductPriceService productPriceService;
	 ...
	 @GetMapping("/")
	    ...
	    @PutMapping("/")
	    public Optional<List<Product>> updateProductPrices() {
	        return Optional.ofNullable(productPriceService.updateProductPrices());
	    }
